...
#(It also supports complex numbers, which will not be discussed currently).
...
#These are covered in the Python documentation <https://docs.python.org/3/tutorial/introduction.html#strings>
